...
#define FIRE_DETECTION_ROUNDS 3
#define MIN_SENSORS_FOR_FIRE 3

// Constantes de advertencia
#define WARNING_TEMP_THRESHOLD 30.0
#define WARNING_HUMIDITY_THRESHOLD 40.0
#define WARNING_SMOKE_THRESHOLD 400
